...
# settings — only STORAGES is honoured. Plain storage in dev (runserver-friendly);
# production overrides staticfiles with a content-hashing backend for cache-busting.
STORAGES = {
